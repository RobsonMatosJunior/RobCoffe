class Calculator {
  ...
  const botaoCalculo = document.querySelectorAll('[calculo]')
  ...
  botaoresultado.addEventListener('click', button => {
    calculator.compute()
    calculator.updateDisplay()
  })
  
  limparTudo.addEventListener('click', button => {
    calculator.limpar()
    calculator.updateDisplay()
  })
